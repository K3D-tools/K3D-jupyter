...
_PLOT_PARAMS = (
    ...
    ("cinematicDenoise", "cinematic_denoise"),
    ("cinematicBokehSize", "cinematic_bokeh_size"),
    ("cinematicFocusDistance", "cinematic_focus_distance"),
    ("cinematicApertureBlades", "cinematic_aperture_blades"),
    ("renderingSteps", "rendering_steps"),
