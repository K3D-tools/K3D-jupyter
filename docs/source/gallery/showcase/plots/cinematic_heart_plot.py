...
def generate():
    ...
    # OrRd_r with its colour channels lifted above 1: the transfer function is what the medium
    # emits and reflects, so values over unity are a brighter tissue, not a clipped one
