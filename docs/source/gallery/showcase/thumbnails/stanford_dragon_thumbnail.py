...
def generate():
    ...
    # the scan is authored Y-up: rotating the data rather than the model matrix keeps the
    # bounds honest for the camera and the floor derived from them
    ...
    # the floor is what the bounced light comes from; without it a path traced model floats
    # in the environment and reads flatter than it is
