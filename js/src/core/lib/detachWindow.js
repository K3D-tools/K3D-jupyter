...
function detachWindowButton(container, K3D) {
    var newWindow,
        ...
        detachedDomText = 'K3D work in deatach window mode. Please close window or click on this text to attach it here.';
    ...
    function reinitializeK3D(DOM) {
        ...
        var objects = K3D.getWorld().K3DObjects.children.reduce(function (prev, object) {
...
module.exports = detachWindowButton;
