...
function screenshotButton(container, K3D) {
    ...
    element.addEventListener('click', function (event) {
        if (!element.hasAttribute('to-download')) {
            ...
            element.removeAttribute('to-download');
            element.download = 'K3D-' + Date.now() + '.png';
        }
    });
