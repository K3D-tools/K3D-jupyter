...
const PLOT_HANDLERS = {
    ...
    cinematic_seed: (v) => v.K3DInstance.setCinematicSeed(v.model.get('cinematic_seed')),
    cinematic_denoise: (v) => v.K3DInstance.setCinematicDenoise(v.model.get('cinematic_denoise')),
    cinematic_bokeh_size: (v) => v.K3DInstance.setCinematicBokehSize(v.model.get('cinematic_bokeh_size')),
    cinematic_focus_distance: (v) => v.K3DInstance.setCinematicFocusDistance(v.model.get('cinematic_focus_distance')),
    cinematic_aperture_blades: (v) => v.K3DInstance
        .setCinematicApertureBlades(v.model.get('cinematic_aperture_blades')),
    ...
    whenConnected(el).then(() => {
        ...
        try {
            view.K3DInstance = new K3D(ThreeJsProvider, container, {
                ...
                cinematicSeed: model.get('cinematic_seed'),
                cinematicDenoise: model.get('cinematic_denoise'),
                cinematicBokehSize: model.get('cinematic_bokeh_size'),
                cinematicFocusDistance: model.get('cinematic_focus_distance'),
                cinematicApertureBlades: model.get('cinematic_aperture_blades'),
